...
export default function Taiwanmap() {
    ...
    return <>
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <path id="TWN1156" className="basetwcolor" d="M739.8,857.3l1.9,5.8l-3,5l-5.6,2.4l-1.4,3.2l1,4l5.6,3.6l6.3,5.2l2.8,7.6l0.3,2.5l-15.6,3.8
	...
	l18.5-9.4l4.3,1l5.8,2.2l4.2,5.9L739.8,857.3L739.8,857.3z"/>
            <path id="TWN1158" className="basetwcolor" d="M569.4,1166l2,2.9l-0.3,1l-2.7,1.8l-5,4.3l-0.9-3.3l1.4-2.7l2.8-3.6h2L569.4,1166L569.4,1166z
	...
	l13.1,6.6l6.6-5.9l7.2-1.8l7.6,8.9l5.9,5.5l8.5-6.7l4.3-0.2L696.1,1022.7L696.1,1022.7z"/>
            <path id="TWN1160" className="basetwcolor" d="M483.8,968.3l-0.6,1.2l-2.3-2l-1.7-4.2l0.3-1.3h0.7l0.9,1.2l0.7,1.9l2.1,2.2L483.8,968.3
	...
	L643.6,916.9z"/>
            <path id="TWN1161" className="basetwcolor" d="M724.3,489l-0.2,0.2l-4.6,1.1l-4.4-1.7l-2.7-3.8l-4.3-2.6l-6.9-2.7l1.2-4.1l5.5-11.4l2.2-3
	...
	l-3.4,4.3l-2.3,5.6L724.3,489L724.3,489z"/>
            <path id="TWN1162" className="basetwcolor" d="M843.1,523.6l-2.3,6.5l-1.4,4.7l0.6,4.4l-3.8,5.8l-14,14.2l-4.3,10.5l-2.8-0.8l-10.6,1l-0.8,0.6
	...
	"/>
            <path id="TWN1163" className="basetwcolor" d="M982.4,448.9l2.1,0.5l1.6,2.2l-0.7,2.3l-3.8-0.1l-1.4-0.8l-1.7-2.7l0.9,0.3L982.4,448.9
	...
	L935.4,601.5z"/>
            <path id="TWN1164" className="basetwcolor" d="M934.8,365l-0.3,11.9l0.2,3l3.7,3.9l-0.4,2.5l-2.5,1.8l-4,1.5l-5.1-0.6l-10.6-4.4l-3-2.2l-3.7-3.4
	l-2.8-3.5l-1.7-3.5l-2.9-3.7l-0.6-2.9l3.2-2.2l7.2-3.1l4.4-2.9l1.4,0.9l2.4,2.7l3.9,1.4L934.8,365L934.8,365z"/>
            <path id="TWN1165" className="basetwcolor" d="M724.3,489l4.4,11.1l3.9,4.4l6,4.5l12.1,5.7l3.9,3.4l0.7,5.2l-0.3,3.9l-0.8,3.5l-1,3.1l1,2.9l1,4
	...
	l4.3,2.6l2.7,3.8l4.4,1.7l4.6-1.1L724.3,489L724.3,489z"/>
            <path id="TWN1166" className="basetwcolor" d="M897.4,413.2l-4.2,1.7l-5.8-0.1l-4.8-1l-3.7-3.3l-3.8-4.3l-5.8-4.6l-3.9-6.7l1.5-7.4l-1.2-6.3
	...
	l1.6,4.4l-1.6,6.6l0.1,5.1l4.6,2.6l3.8,3.2l-2,4.3L897.4,413.2L897.4,413.2z"/>
            <path id="TWN1167" className="basetwcolor" d="M915.9,357.2l-4.4,2.9l-7.2,3.1l-3.2,2.2l0.6,2.9l2.9,3.7l1.7,3.5l2.8,3.5l3.7,3.4l3,2.2l10.6,4.4
	...
	L897.4,413.2L897.4,413.2z"/>
            <path id="TWN1168" className="basetwcolor" d="M861.8,498.8l-3.1,0.9l-5.4,3.9l3.1,12.4l-2.2,3.8l-3.4,1.3l-3.3-0.6l-3.9,1.6l-0.5,1.5l-4.8-2.2
	...
	l-1.5,5.3l-3.1,3.7l0.8,5.2l1.4,5.6l8.9,8.5L861.8,498.8L861.8,498.8z"/>
            <path id="TWN1169" className="basetwcolor" d="M647.2,689.6l0.1,3.6l-4.3,1.6l-1.2,2.9l0.5,4l-2,4.6l-1.6,5.4l-0.1,5.7l-1.2,6.6l-0.9,13.4
	...
	l0.1,4l1.2,3.3l4.3,0.8l5.4,3.5V689.6L647.2,689.6z"/>
            <path id="TWN1170" className="basetwcolor" d="M499.6,893.2l-1.8,1.4l-0.4-1.1l2.4-3.1l0.9-2.4l1.1-1.5l0.6,0.5l0.1,1.1l-1.4,2L499.6,893.2
	...
	l7.3,1.7l6.8-2.7l4.5-0.6l3-2.2l-2.5-6.8l-2.5-4l-4.1-2.2l-5.6-2.1l-7.8,0.7L573.8,836.5L573.8,836.5z"/>
            <path id="TWN1171" className="basetwcolor" d="M573.8,836.5l9.3-1.6l7.8-0.7l5.6,2.1l4.1,2.2l2.5,4l2.5,6.8l-3,2.2l-4.5,0.6l-6.8,2.7l-7.3-1.7
	l-7-4.5l-6.1-2.4l-0.9-5.6L573.8,836.5L573.8,836.5z"/>
            <path id="TWN1172" className="basetwcolor" d="M935.4,601.5l0.6,0.8l1.6,2.9l0.2,1.1l-1.4,2.4l-5.8,5.7l-6.2,8.6l-4.7,3.7l-1.4,2l0.7,2.1
	...
	l0.4-4.2l4.7-4.9l2.5,2.1l6.5,3.1l15,3.8l8.3,3.2h6.5l4.9-4.5l2.4-6l3.8-0.9l18.5,11.1l11.1,1.7L935.4,601.5L935.4,601.5z"/>
            <path id="TWN1173" className="basetwcolor" d="M825,627.6l1.4,6.2l0.2,3.7l-5.2,2.4l-6.6,2.2l-3.7,2.9l0.2,9.9l2.9,3.1l5.2,3.4l1.5,4.5l-0.3,3.9
	...
	l2.6-5.5l4.7-3.9l6.6,0.1l5-1.9l7.9-7.6l5.1-2.9l4.4-0.8l8.8-4.7l6.2-0.2l6.3-1l11.1-4.4l4.6-0.3l4.7,1L825,627.6L825,627.6z"/>
            <path id="TWN1174" className="basetwcolor" d="M803.7,570.5l0.8-0.6l10.6-1l2.8,0.8l3.6,1l-0.6,5.5l1.4,3.8l4.9,1l4.4,2.6l3.7,2.5l4-0.6l4.7-2.3
	...
	l6,2.4l5,5.6l5.4,2.1l8.9-4.7l6.8-2.9l11.6-9.2l5.9-3.2l4.6-4.4l4.2-3l5.3,0.1l4.9-2l1.8-5.6L803.7,570.5L803.7,570.5z"/>
            <path id="TWN1176" className="basetwcolor" d="M642,760.2l1.9,7.2l-2,4.7l-1,7.2l1,7.7l-1.9,5.2l-0.9,5.7l4,4.7l5.8,2.5l6.8-2l8.2-0.9l2.6,3.5
	...
	l19.7,2.3l12.2,6l5.8-0.1l12,2.4L642,760.2L642,760.2z"/>
            <path id="TWN1177" className="basetwcolor" d="M889.2,1263l-5.5,1.7l-7.3-2.9l-6.8-4.8l-3.9-3.7l1.2-2.7l-0.1-2.5l-1-2.4l-1.7-2.1h19.5v1.8
	...
	l-1.7,16.1L702.1,1199.5L702.1,1199.5z"/>
            <path id="TWN3414" className="basetwcolor" d="M320.7,926.5l-1.8,0.9l-1.3-1.5l-1.5-4.7l1-1.2l3.8-1.3l2.7,0.7l0.1,2.1l-0.2,1.6l-1.2,1.2
	...
	L362.8,803.3z M365.4,772.9l-0.3,0.9l-1.3-3l-0.2-1.4l1.8-1.5l1.6-3l0.5,1.1l2.5,1.4l-0.4,1.8l-2.2,1.3L365.4,772.9z"/>
            <path id="TWN3415" className="basetwcolor" d="M9.2,576.4L4,577.9l-3-1.2l5-9.9l1.3-1.4l2.1-0.5l2.1-0.1l2,1.4l1.6,1.8v3.1l-1.4,2.1l-1.6,0.1
	...
	L333.5,411.9L333.5,411.9z"/>
            <path id="TWN5128" className="basetwcolor" d="M469.2,123.9l-0.2,2.3l-1.9,2.1l-4.1,2l2.5-5.6l2.5,0.5l0.1-0.9L469.2,123.9z M457.4,123.1l-2,2.1
	...
	l2.6,1.5l0.6,1.3L605.3,4.8z"/>
            <rect id="_x30_" x="894" y="358" className="basetwcolor" width="0" height="0" />
            <rect id="_x31_" x="669.9" y="526.1" className="basetwcolor" width="0" height="0" />
            <rect id="_x32_" x="569.7" y="1021.4" className="basetwcolor" width="0" height="0" />
        </svg>
